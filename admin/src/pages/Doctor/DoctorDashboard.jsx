          ...
          <div className="pt-4 border border-t-0">
            {dashData.latestAppointments.map((item, index) => (
              ...
              >
                ...
                {item.cancelled ? (
                  <p className="text-red-600 text-xs font-medium text-center  px-1 py-1 rounded-full">
                    Cancelled
                  </p>
                ) : item.isCompleted ? (
                  <p className="text-xs font-medium text-center px-1 py-1 rounded-full text-green-600 ">
                    Completed
                  </p>
                ) : (
                  <div className="flex">
